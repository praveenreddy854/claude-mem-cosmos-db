...
**Symptoms**: `/plugin install claude-mem-cosmos-db` fails.
...
3. Verify installation:
   ```bash
   ls -la ~/.claude/plugins/marketplaces/praveenreddy854/
   ```
...
2. **Create issue**: [GitHub Issues](https://github.com/praveenreddy854/claude-mem-cosmos-db/issues)
