...
Every Cursor session starts fresh - your AI doesn't remember what it worked on yesterday. Claude-Mem Cosmos DB builds on Claude-Mem and adds optional Azure Cosmos DB-backed shared memory so your agent can retain cumulative knowledge across machines.
...
cd claude-mem-cosmos-db && bun install && bun run build
