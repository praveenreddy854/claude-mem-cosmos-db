    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          CLAUDE_MEM_REMOTE_DB_ENABLED: data.CLAUDE_MEM_REMOTE_DB_ENABLED || DEFAULT_SETTINGS.CLAUDE_MEM_REMOTE_DB_ENABLED,
          CLAUDE_MEM_REMOTE_DB_PROVIDER: data.CLAUDE_MEM_REMOTE_DB_PROVIDER || DEFAULT_SETTINGS.CLAUDE_MEM_REMOTE_DB_PROVIDER,
          CLAUDE_MEM_REMOTE_DB_SYNC_INTERVAL_MS: data.CLAUDE_MEM_REMOTE_DB_SYNC_INTERVAL_MS || DEFAULT_SETTINGS.CLAUDE_MEM_REMOTE_DB_SYNC_INTERVAL_MS,
          CLAUDE_MEM_AZURE_COSMOS_CONNECTION_STRING: data.CLAUDE_MEM_AZURE_COSMOS_CONNECTION_STRING || DEFAULT_SETTINGS.CLAUDE_MEM_AZURE_COSMOS_CONNECTION_STRING,
          CLAUDE_MEM_AZURE_COSMOS_ENDPOINT: data.CLAUDE_MEM_AZURE_COSMOS_ENDPOINT || DEFAULT_SETTINGS.CLAUDE_MEM_AZURE_COSMOS_ENDPOINT,
          CLAUDE_MEM_AZURE_COSMOS_KEY: data.CLAUDE_MEM_AZURE_COSMOS_KEY || DEFAULT_SETTINGS.CLAUDE_MEM_AZURE_COSMOS_KEY,
          CLAUDE_MEM_AZURE_COSMOS_DATABASE: data.CLAUDE_MEM_AZURE_COSMOS_DATABASE || DEFAULT_SETTINGS.CLAUDE_MEM_AZURE_COSMOS_DATABASE,
          CLAUDE_MEM_AZURE_COSMOS_CONTAINER: data.CLAUDE_MEM_AZURE_COSMOS_CONTAINER || DEFAULT_SETTINGS.CLAUDE_MEM_AZURE_COSMOS_CONTAINER,
