...
- [ ] I searched [existing issues](https://github.com/praveenreddy854/claude-mem-cosmos-db/issues) and confirmed this is not a duplicate
...
**Plugin Paths:**
- **macOS/Linux**: `~/.claude/plugins/marketplaces/praveenreddy854`
- **Windows**: `%USERPROFILE%\.claude\plugins\marketplaces\praveenreddy854`
